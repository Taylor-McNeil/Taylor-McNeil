...
<table>
  <tr>
   <td width="33%" style="vertical-align: top;">
    ...
    <td width="33%" style="vertical-align: top;">
     ...
     <td width="33%" style="vertical-align: top;">
        <strong><a href="https://medium.com/codex/tic-tac-toe-e53212028341">🎮 Tic Tac Toe Java Tutorial</a></strong><br>
  ...
  <tr>
      <td width="33%" style="vertical-align: top;">
        ...
        <em>A hands-on workshop that lets devs create dynamic generative NFTs using Stellar</em><br>
    </td>
    <td width="33%" style="vertical-align: top;">
      <strong>☕ <a href="https://www.youtube.com/watch?v=eUJDmLEVtjU&ab_channel=ThatDevTaylorGames">Java Programming Tutorial </strong><br>
      <code>Java</code> <code>Tutorial</code> <code>How to Guide</code><br>
      <em> A video explanation of how to solve a leetcode problem using Java.</em><br>
    </td> 
         <td width="33%" style="vertical-align: top;">
  </td>
  </tr>
